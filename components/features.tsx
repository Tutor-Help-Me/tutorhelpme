        ...
        <div className="justify-items-stretch pt-5 text-white grid grid-rows-2 grid-flow-col gap-5">
          ...
          <div className="group relative overflow-hidden bg-white px-10 pt-10 pb-10 shadow-xl ring-1 ring-gray-900/5 transition-primary duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div className="relative">
              <a href="/" className="shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] text-4xl grid h-20 w-20 place-items-center rounded-full bg-blue-700 transition-primary duration-300 group-hover:bg-white group-hover:text-blue-700">
                P
              ...
              <div
                className="space-y-6 pt-5 leading-7 text-slate-900 transition-primary duration-300 group-hover:text-white">
                <p className="text-3xl">Primary</p>
              </div>
              <div className="pt-5 text-base font-semibold leading-7">
                <button type="button"
                  className="transition-primary duration-300 ease-in-out bg-white shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] group-hover:border-white border-2 border-blue-700 px-10 py-2 text-xs font-medium uppercase leading-normal text-blue-700">
                  Learn more -->
                </button>
              </div>
            </div>
          ...
          <div className="group relative overflow-hidden bg-white px-10 pt-10 pb-10 shadow-xl ring-1 ring-gray-900/5 transition-primary duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div className="relative">
              <a href="/" className="shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] text-4xl grid h-20 w-20 place-items-center rounded-full bg-green-600 transition-primary duration-300 group-hover:bg-white group-hover:text-green-600">
                A
                {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="h-10 w-10 text-white transition-primary">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332 48.294 48.294 0 005.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                </svg> */}
              ...
              <div
                className="space-y-6 pt-5 leading-7 text-slate-900 transition-primary duration-300 group-hover:text-white">
                <p className="text-3xl">A-Level</p>
              </div>
              <div className="pt-5 text-base font-semibold leading-7">
                <button type="button"
                  className="transition-primary duration-300 ease-in-out bg-white shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] group-hover:border-white border-2 border-green-600 px-10 py-2 text-xs font-medium uppercase leading-normal text-green-600">
                  Learn more -->
                </button>
              </div>
            </div>
          ...
          <div className="group relative overflow-hidden bg-white px-10 pt-10 pb-10 shadow-xl ring-1 ring-gray-900/5 transition-primary duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div className="relative">
              <a href="/" className="shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] text-4xl grid h-20 w-20 place-items-center rounded-full bg-orange-500 transition-primary duration-300 group-hover:bg-white group-hover:text-orange-500">
                G
                {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="h-10 w-10 text-white transition-primary">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332 48.294 48.294 0 005.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                </svg> */}
              ...
              <div
                className="space-y-6 pt-5 leading-7 text-slate-900 transition-primary duration-300 group-hover:text-white">
                <p className="text-3xl">GCSE</p>
              </div>
              <div className="pt-5 text-base font-semibold leading-7">
                <button type="button"
                  className="transition-primary duration-300 ease-in-out bg-white shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] group-hover:border-white border-2 border-orange-500 px-10 py-2 text-xs font-medium uppercase leading-normal text-orange-500">
                  Learn more -->
                </button>
              </div>
            </div>
          ...
          <div className="group relative overflow-hidden bg-white px-10 pt-10 pb-10 shadow-xl ring-1 ring-gray-900/5 transition-primary duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div className="relative">
              <a href="/" className="shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] text-4xl grid h-20 w-20 place-items-center rounded-full bg-purple-600 transition-primary duration-300 group-hover:bg-white group-hover:text-purple-600">
                11
                {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" className="h-10 w-10 text-white transition-primary">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 01.778-.332 48.294 48.294 0 005.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                </svg> */}
              ...
              <div
                className="space-y-6 pt-5 leading-7 text-slate-900 transition-primary duration-300 group-hover:text-white">
                <p className="text-3xl">11 Plus</p>
              </div>
              <div className="pt-5 text-base font-semibold leading-7">
                <button type="button"
                  className="transition-primary duration-300 ease-in-out bg-white shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] group-hover:border-white border-2 border-purple-600 px-10 py-2 text-xs font-medium uppercase leading-normal text-purple-600">
                  Learn more -->
                </button>
              </div>
            </div>
          ...
          <div className="row-span-2 col-span-2 group relative overflow-hidden bg-white px-10 pt-10 pb-10 shadow-xl ring-1 ring-gray-900/5 transition-primary duration-300 hover:-translate-y-1 hover:shadow-2xl">
            ...
            <div className="relative">
              <a href="/" className="shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] text-4xl grid h-20 w-20 place-items-center rounded-full bg-fuchsia-600 transition-primary duration-300 group-hover:bg-white group-hover:text-fuchsia-600">
              ...
              <div
                ...
                <div className="pt:10 flex items-center justify-center space-x-4 text-lg text-center text-slate-900">
              ...
              <div className="pt-5 text-base font-semibold leading-7">
                <button type="button"
                  className="w-full transition-primary duration-300 ease-in-out bg-white shadow-[0_4px_9px_-4px_#000000] hover:shadow-[0_6px_12px_-3px_#000000] group-hover:border-white border-2 border-fuchsia-600 px-10 py-2 text-xs font-medium uppercase leading-normal text-fuchsia-600">
